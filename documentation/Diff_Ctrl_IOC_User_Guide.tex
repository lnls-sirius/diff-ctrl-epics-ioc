...
\section{Process Variables Description}\label{sec:process-variables}
    ...
    \begin{longtable}{| m{3.0cm} m{4.5cm}  m{7.0cm} |}
        ...
        % --- row ---
        NegativeDoneMov-Mon &  & \begin{tabular}{@{}m{6cm}@{}}
        ...
        % --- row ---
        PositiveDoneMov-Mon &  & \begin{tabular}{@{}m{6cm}@{}}
        ...
        % --- row ---
        NegativeEdgePos-SP &  & \begin{tabular}{@{}m{6cm}@{}}
        ...
        % --- row ---
        NegativeEdgePos-RB &  & \begin{tabular}{@{}m{6cm}@{}}
        ...
        % --- row ---
        PositiveEdgePos-SP &  & \begin{tabular}{@{}m{6cm}@{}}
            ...
            \end{tabular} \hypertarget{}{}\\ \hline
        % --- row ---
        PositiveEdgePos-RB &  & \begin{tabular}{@{}m{6cm}@{}}
        ...
        % --- row ---
        CoordConvErr-Mon &  & \begin{tabular}{@{}m{6cm}@{}}
        ...
        % --- row ---
        NegEdgeInnerLim-SP &  & \begin{tabular}{@{}m{6cm}@{}}
        ...
        PositiveEdgeCenter-SP &  & \begin{tabular}{@{}m{6cm}@{}}
            ...
            \end{tabular} \hypertarget{}{}\\ \hline
        % --- row ---
        PositiveEdgeCenter-RB &  & \begin{tabular}{@{}m{6cm}@{}}
        ...
        % --- row ---
        NegativeEdgeCenter-SP &  & \begin{tabular}{@{}m{6cm}@{}}
            ...
            \end{tabular} \hypertarget{}{}\\ \hline
        % --- row ---
        NegativeEdgeCenter-RB &  & \begin{tabular}{@{}m{6cm}@{}}
        ...
        % --- row ---
        PositiveEdgeStep-SP &  & \begin{tabular}{@{}m{6cm}@{}}
        ...
        % --- row ---
        DecPositiveEdge-Cmd &  & \begin{tabular}{@{}m{6cm}@{}}
        ...
        % --- row ---
        IncNegativeEdge-Cmd &  & \begin{tabular}{@{}m{6cm}@{}}
        ...
        % --- row ---
        DecNegativeEdge-Cmd &  & \begin{tabular}{@{}m{6cm}@{}}
        ...
        % --- row ---
        IncCenter-Cmd &  & \begin{tabular}{@{}m{6cm}@{}}
        ...
        % --- row ---
        DecCenter-Cmd &  & \begin{tabular}{@{}m{6cm}@{}}
        ...
        % --- row ---
        IncWidth-Cmd &  & \begin{tabular}{@{}m{6cm}@{}}
        ...
        % --- row ---
        DecWidth-Cmd &  & \begin{tabular}{@{}m{6cm}@{}}
